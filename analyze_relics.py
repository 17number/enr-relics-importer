...
EFFECT_LIST = [
    ...
    "出撃時の武器の祈祷を「竜炎」にする",
    "出撃時の武器の祈祷を「雷の槍」にする",
    "出撃時の武器の祈祷を「黄金の怒り」にする",
    "出撃時の武器の魔術を「カーリアの大剣」にする",
    "出撃時の武器の魔術を「夜のつぶて」にする",
    "出撃時の武器の魔術を「溶岩弾」にする",
    "出撃時の武器の魔術を「罰の茨」にする",
    "出撃時の武器の魔術を「魔術の輝剣」にする",
    "出血耐性上昇",
    "出血耐性上昇＋１",
    "刀の攻撃でＦＰ回復",
    "刀の攻撃でＨＰ回復",
...
RELIC_INFO_DICT = {
    "ガラスの首飾り": {"color": "green", "type": "normal"},
    "ちぎれた組み紐": {"color": "blue", "type": "normal"},
    "にび色の砥石": {"color": "red", "type": "normal"},
    "安寧者の意思": {"color": "blue", "type": "normal"},
    ...
    "瓦礫の夜": {"color": "red", "type": "normal"},
    "忌み鬼の呪物": {"color": "blue", "type": "normal"},
    "記録「後継者へ」": {"color": "yellow", "type": "normal"},
